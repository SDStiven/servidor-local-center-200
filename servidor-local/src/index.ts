...
app.use(cors({
    origin: ["http://localhost:3000", "https://servidor-local-center-backend2.onrender.com", "https://servidor-local-center-200-catxupa.vercel.app", "https://servidor-local-center-200.vercel.app"],
    credentials: true,
